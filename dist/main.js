...
/***/ "./src/app/_lib/colocation.service.ts":
/*!********************************************!*\
  !*** ./src/app/_lib/colocation.service.ts ***!
  \********************************************/
/*! exports provided: ColocationService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColocationService", function() { return ColocationService; });
...
/* harmony import */ var _models_Login_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_models/Login.model */ "./src/app/_models/Login.model.ts");
...
var ColocationService = /** @class */ (function () {
    function ColocationService(_http) {
        this._http = _http;
        this.connected = false;
        this.myLogin = new _models_Login_model__WEBPACK_IMPORTED_MODULE_4__["Login"]('', '');
        this.current_api = "http://grandappapi.grandapp.xyz/"; //"http://creaxisapi.creaxis.xyz/";
    }
    ColocationService.prototype.validarLogin = function (login) {
        ...
        return this._http.post(this.current_api + 'api/colocatechapi/login/', body, requestOptions).map(function (data) {
            return data.json();
        });
    };
    ColocationService = __decorate([
...
/* harmony import */ var _lib_colocation_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./_lib/colocation.service */ "./src/app/_lib/colocation.service.ts");
...
// import { LoginComponent } from './system/adm/Login/login/login.component';
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_lib_colocation_service__WEBPACK_IMPORTED_MODULE_14__["ColocationService"]],
...
module.exports = "<footer class=\"footer \">\n  <div class=\"container\">\n    <nav class=\"pull-left\">\n      <ul>\n        <li>\n          <a href=\"https://www.colocacioneshonduras.com\">\n            Colocaciones Honduras\n          </a>\n        </li>\n        <li>\n          <a href=\"\">\n            About Us\n          </a>\n        </li>\n        <li>\n          <a href=\"\">\n            Blog\n          </a>\n        </li>\n        <li>\n          <a href=\"\">\n            Licenses\n          </a>\n        </li>\n      </ul>\n    </nav>\n    <div class=\"copyright pull-right\">\n      &copy;\n      {{test | date: 'yyyy'}}, Hecho por\n      <a href=\"https://www.colocacioneshonduras.com\" target=\"_blank\">Panda Corp.</a> Soluciones colectivas.\n    </div>\n  </div>\n</footer>\n"
...
/* harmony import */ var _lib_colocation_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_lib/colocation.service */ "./src/app/_lib/colocation.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(_auxiliarService) {
    ...
    SidebarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_lib_colocation_service__WEBPACK_IMPORTED_MODULE_2__["ColocationService"]])
    ], SidebarComponent);
...
module.exports = __webpack_require__(/*! /Users/dennismenjivar/Documents/Collocations/src/main.ts */"./src/main.ts");
